...
def open_dialog():
    ...
    Label(tab2, text=f"reports will reside in directory: {report_path}", foreground="red", font=constants.WIDGET_FONT_COLOR).grid(row=18, sticky=constants.WIDGET_REGION)
...
Label(tab1, text= "Password *", fg=constants.FOREGOUND_COLOR_BLUE, font=constants.WIDGET_FONT_COLOR).grid(row=3, sticky=constants.WIDGET_REGION)
Entry(tab1, textvariable=password, bg="lightgray", width=25, show="*").grid(row=4, sticky=constants.WIDGET_REGION)
Button(tab1, text='Switch to reports', command=select_tab, font=constants.WIDGET_FONT_COLOR).grid(row=5, sticky=constants.WIDGET_REGION)
...
Label(tab2, text= "Report start date", fg=constants.FOREGOUND_COLOR_BLUE, font=constants.WIDGET_FONT_COLOR).grid(row=9, sticky=constants.WIDGET_REGION)
...
Label(tab2, text= "Report end date", fg=constants.FOREGOUND_COLOR_BLUE, font=constants.WIDGET_FONT_COLOR).grid(row=11, sticky=constants.WIDGET_REGION)
...
Label(tab2, text="Select environment *", fg=constants.FOREGOUND_COLOR_BLUE, font=constants.WIDGET_FONT_COLOR).grid(row=14, sticky=constants.WIDGET_REGION)
Checkbutton(tab2, text = "Sandbox", variable=sandbox, font=constants.WIDGET_FONT_COLOR).grid(row=15, sticky=constants.WIDGET_REGION)
Checkbutton(tab2, text = "Production", variable=production, font=constants.WIDGET_FONT_COLOR).grid(row=15, column=1, sticky=constants.WIDGET_REGION)
Button(tab2, text="Select path", width=20, font=constants.WIDGET_FONT_COLOR, command=open_dialog).grid(row=17, sticky=constants.WIDGET_REGION)
Button(tab2, text="Submit", width="18", bg="white", highlightbackground="#98fb98", command=register_user, font=constants.WIDGET_FONT_COLOR).grid(row=20, sticky=constants.WIDGET_REGION)
